...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //,-----------------------------------------.                ,---------------------------------------------.
     KC_MINS, KC_Q,  KC_W,  KC_E,  KC_R,  KC_T,                   KC_Y,  KC_U,  KC_I,  KC_O,  KC_P,   KC_NO,
  //|------+------+------+------+------+------|                |------+------+-------+------+-------+--------|
     KC_EQL,     HM_A,  HM_S,  HM_D,  HM_F,  KC_G,                KC_H,  HM_J,  HM_K,  HM_L,  HM_P, KC_SCLN,
  //|------+------+------+------+------+------|                |------+------+-------+------+-------+--------|
     KC_GRV,  KC_Z,  KC_X,  KC_C,  KC_V,  KC_B,                  KC_N,  KC_M,KC_COMM,KC_DOT,KC_SLSH, KC_NO,
  //|------+------+------+------+------+------+------|  |------+------+------+-------+------+-------+--------|
            KC_TAB, LT(_OUTER_L,KC_SPC), LT(_INNER_L,KC_ENT),  LT(_INNER_R,KC_ENT), LT(_OUTER_R,KC_BSPC), KC_ESC
                              //`--------------------'  `--------------------'
  ),
  ...
  //|------+------+------+------+------+------|                |------+------+-------+------+-------+--------|
     KC_EQL,     CM_A,  CM_R,  CM_S,  CM_T,  KC_G,                KC_M,  CM_N,  CM_E,  CM_I,  CM_O, KC_SCLN,
  //|------+------+------+------+------+------|                |------+------+-------+------+-------+--------|
     KC_GRV,  KC_Z,  KC_X,  KC_C,  KC_D,  KC_V,                KC_K,  KC_H,KC_COMM,KC_DOT,KC_SLSH, KC_MUTE,
  //|------+------+------+------+------+------+------|  |------+------+------+-------+------+-------+--------|
     KC_TAB, LT(_OUTER_L,KC_SPC), LT(_INNER_L,KC_ENT),  LT(_INNER_R,KC_ENT), LT(_OUTER_R,KC_BSPC), KC_ESC
                              //`--------------------'  `--------------------'
  ),
  ...
  //,-----------------------------------------.                ,-----------------------------------------.
    KC_NO, KC_NO,RGBRST, KC_NO, KC_NO, KC_NO,                     KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
